...
LogFileRootDir = '../5G/'
# 输出文档根目录
OutputFileDir = '../5G/LogClusterResult-5G/'
...
shutil.rmtree('../5G/LogClusterResult-5G/clusters')
shutil.copytree('../Data/LogClusterResult/clusters','../5G/LogClusterResult-5G/clusters')
