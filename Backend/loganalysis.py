...
logclusterTool = '../logcluster/logcluster/logcluster.pl'
# 文件放至在 ../Data/LogFiles文件夹中
LogFileRootDir = '../k8s/'
# 输出文档根目录
OutputFileDir = '../k8s/LogClusterResult-k8s/'
...
shutil.rmtree('../k8s/LogClusterResult-k8s/clusters')
shutil.copytree('../Data/LogClusterResult/clusters','../k8s/LogClusterResult-k8s/clusters')
